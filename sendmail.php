...
if ( isset($_POST['email']) && isset($_POST['name']) && isset($_POST['subject']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) ) {
...
$txt = "\r\n".$date.', Name: '.$_POST['name'].', Email: '.$_POST['email'].', My Phone: '.$_POST['subject'];
